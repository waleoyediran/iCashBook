...
public class Trans extends javax.swing.JDialog{
    ...
    private OnButton addButton=new OnButton("_addOn.gif","_addOff.gif"){
        ...
        public void doAction(){
            ...
            app.getModel().add(particular,amount,transactionType,new java.util.Date());//date at which this transaction is entered
    ...
    private OnButton updateButton=new OnButton("_editOn.gif","_editOff.gif"){
        ...
        public void doAction(){
            ...
            //update the field
            app.getModel().edit(source.getSerialNo(),particular,transactionType,amount,new java.util.Date());
